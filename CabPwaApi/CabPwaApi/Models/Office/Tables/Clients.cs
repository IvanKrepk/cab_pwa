...
[Index("ClientName", Name = "IX_ClientsByName", IsUnique = true)]
public partial class Clients
{
    ...
    public DateOnly? BeginingContractWork { get; set; }
    ...
    [InverseProperty("ClientCodeNavigation")]
    public virtual ICollection<BalanceByClientsPurses> BalanceByClientsPurses { get; set; } = new List<BalanceByClientsPurses>();

    [InverseProperty("ClientCodeNavigation")]
    public virtual ICollection<WebAccessLogins> WebAccessLogins { get; set; } = new List<WebAccessLogins>();
